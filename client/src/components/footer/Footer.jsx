            ...
            <div className="grid grid-flow-col gap-4 ">
              <a href="/#">
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  className="fill-current hover:text-pink-300  hover:w-[52px] duration-500 "
                >
              ...
              <a href="/#">
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  className="fill-current hover:text-pink-300 duration-500 hover:w-[52px] "
                >
              ...
              <a href="/#">
                <svg
                  ...
                  height="24"
                  viewBox="0 0 24 24"
                  className="fill-current duration-500 hover:text-pink-300 hover:w-[52px]"
                >
